...
public final class PngDecodeService extends FixtureDecodeService {
    ...
    @Override public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        boolean bundled = "purrview-oob.png".equals(asset) && privateFile == null;
        boolean generated = asset == null && "purrview-ai.png".equals(privateFile);
        ...
        try (InputStream input = bundled
            ...
            stopSelf(startId);
            String result = decodePng(bytes, fixed);
